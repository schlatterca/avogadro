...
import { f as defineStore, c as useNuxtApp, d as asyncDataDefaults, e as createError, b as useRuntimeConfig } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        if (myData.value.title) {
          _push(`<p class="text-l uppercase">${(_a = myData.value.title) != null ? _a : ""}</p>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (myData.value.description) {
          _push(`<p class="text-l mt-8">${(_c = myData.value.description) != null ? _c : ""}</p>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=_slug_-BFajKo88.mjs.map
