  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<!--]--></section><section id="s_3"><p>Trasformare uno spazio in un luogo<br> di senso che faccia star bene chi<br> ci trascorre del tempo \xE8 per me<br> una gioia, ma non solo: \xE8 il mezzo<br> con cui faccio la mia parte nella<br> societ\xE0 civile.</p></section><section id="s_4"><!--[-->`);
...
//# sourceMappingURL=index-Cr_X7XvP.mjs.map
