...
import { ref, unref, useSSRContext, watch, nextTick, watchEffect, getCurrentScope, onScopeDispose, getCurrentInstance, computed } from 'vue';
...
setTimeout(() => {
  (void 0).querySelectorAll("#s_2 .slide");
  if ((void 0).querySelector("#s_2").classList.contains("inView")) {
    setTimeout(() => {
      idleScroll();
    }, 3e3);
  }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div><main id="mainHome"><section id="s_1"></section><div id="leftArrow" class="arrow"></div><div id="rightArrow" class="arrow"></div><div class="overlay bg-white" id="overlay_slide"></div><section id="s_2"><figure class="slide"><img src="https://freight.cargo.site/t/original/i/eb7592ba1f63f887f8bfefe0682439c59867bdf787af1ada187e871fa91a7447/_Z9A3926.jpg"></figure><figure class="slide"><img src="https://freight.cargo.site/t/original/i/2a7cd7086a218f34084b4a2bcba1682f8eeec2272068baf14898a753f0279647/_Z9A3936.jpg"></figure><figure class="slide"><img src="https://freight.cargo.site/t/original/i/9f672c4aeda59bf5c45247795ff7f5cf9bbd74b9e5e6043597515054de662b08/_Z9A3872_a.jpg"></figure></section><section id="s_3"><p>Trasformare uno spazio in un luogo<br> di senso che faccia star bene chi<br> ci trascorre del tempo \xE8 per me<br> una gioia, ma non solo: \xE8 il mezzo<br> con cui faccio la mia parte nella<br> societ\xE0 civile.</p></section><section id="s_4"><!--[-->`);
...
//# sourceMappingURL=index-BZarTlTb.mjs.map
