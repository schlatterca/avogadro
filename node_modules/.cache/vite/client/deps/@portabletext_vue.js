...
function q(e, n, t) {
  return (n = R(n)) in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function R(e) {
  var n = z(e, "string");
...
function we(e) {
  ...
  return n.forEach((r, o) => {
    ...
    r.children.forEach((c) => {
      x(c) ? (t += i && t && !Z.test(t) && !Y.test(c.text) ? " " : "", t += c.text, i = false) : i = true;
    }), o !== n.length - 1 && (t += `
...
var ge = (e, n) => {
  ...
  function o(l, s, u) {
    const f = $({ node: l, index: s, isInline: false, renderNode: t }), y = e.listItem, m = (typeof y == "function" ? y : y[l.listItem]) || e.unknownListItem;
  ...
  function c(l, s, u) {
    const { markDef: f, markType: y, markKey: d } = l, m = e.marks[y] || e.unknownMark, h = l.children.map(
      (g, v) => t({ node: g, index: v, isInline: true, renderNode: t })
    );
...
function $(e) {
  const { node: n, index: t, isInline: r, renderNode: o } = e, c = J(n).map(
    (a, b) => o({ node: a, isInline: true, index: b, renderNode: o })
  );
  return {
    _key: n._key || `block-${t}`,
    children: c,
...
var Ie = W({
  ...
  setup(e) {
    ...
    const t = e, r = () => {
      ...
      return c.map(
        (w, l) => b({ node: w, index: l, isInline: false, renderNode: b })
      );
    };
    return (o, i) => (F(), H(r));
  }
