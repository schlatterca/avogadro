...
function buildKeepAlive(agent2) {
  return function(config2 = {}) {
    const { maxRetries = 3, ms: ms2 = 1e3, maxFree = 256 } = config2, { finalizeOptions } = agent2({
      keepAlive: true,
      keepAliveMsecs: ms2,
    ...
    return {
      ...
      onError: (err, context2) => {
        if ((context2.options.method === "GET" || context2.options.method === "POST") && err instanceof NodeRequestError && err.code === "ECONNRESET" && err.request.reusedSocket) {
          const attemptNumber = context2.options.attemptNumber || 0;
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-ZUKID7YZ.js").then(function(n) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-X2BTKARL.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events() {
    ...
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-X2BTKARL.js")).default : EventSource;
        if (unsubscribed)
          return;
