      ...
      if (loading.value) {
        ...
        ssrRenderList(myData.value.slides, (slide) => {
          ...
          if (slide.description) {
            _push(`<div class="text absolute bottom-0 left-0 w-full z-10 text-white p-20px pr-66% pointer-events-none leading-tight text-base blur-[20px] transition-[filter] duration-[2000ms]"><p class="text-xl mb-8">${slide.title ?? ""}</p><p class="DM-Mono text-base">${slide.description ?? ""}</p></div>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=vision-aYach_wN.js.map
