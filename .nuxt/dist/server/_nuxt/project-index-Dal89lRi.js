    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        ssrRenderList(myData.value, (project, index) => {
          _push(`<div class="${ssrRenderClass([{ "border-t-.6": index === 0 }, "inline-grid grid-cols-10 gap-6px items-end group w-full border-white border-b-.6 py-2 cursor-pointer hover:bg-darkgreyHover"])}"><a${ssrRenderAttr("href", "/progetti/" + project.slug.current)} class="col-span-6"><p class="truncate">${project.title ?? ""}</p></a><p class="text-s col-start-7 col-span-3 truncate">${project.citta ?? ""}</p><p class="projectIndexArrow self-center col-start-10 col-span-1 text-right opacity-0 group-hover:opacity-100"></p></div>`);
        });
        _push(`<!--]--></div></main></div>`);
      }
    };
...
//# sourceMappingURL=project-index-Dal89lRi.js.map
