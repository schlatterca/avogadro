      ...
      if (loading.value) {
        ...
        ssrRenderList(myData.value.slides, (slide, index) => {
          ...
          if (slide.description) {
            _push(`<div class="text fixed m-0 text-white pointer-events-none text-m DM-Mono z-50 opacity-0 blur-0 transition-all duration-[600ms] left-20px md:left-[calc(calc(23vw+2px))] top-[unset] md:top-[50%] bottom-20px md:bottom-[unset] w-auto md:w-80 max-w-[80vw] md:max-w-[unset]"><p class="text-xl mb-8">${slide.title ?? ""}</p><p class="DM-Mono text-m">${slide.description ?? ""}</p></div>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=vision-aQxU2_AR.js.map
