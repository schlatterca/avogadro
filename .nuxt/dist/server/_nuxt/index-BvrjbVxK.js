...
import { _ as _sfc_main$2 } from "./Footer-lemmLdBR.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(` ci trascorre del tempo è per me`);
        if (!unref(isMobile)) {
          _push(`<br>`);
        } else {
          _push(`<!---->`);
        }
        _push(` una gioia, ma non solo: è il mezzo`);
        if (!unref(isMobile)) {
          _push(`<br>`);
        } else {
          _push(`<!---->`);
        ...
        _push(` società civile.</p></section><section id="s_4"><div class="projectGrid relative h-[100dvh] w-screen"><!--[-->`);
        ssrRenderList(unref(sortedProjects), (project) => {
          ...
          if (!unref(isMobile) && project.homepage_image) {
            _push(`<figure class="w-full group"><p class="projectName opacity-0 group-hover:opacity-100 transition-opacity duration-500 fixed pointer-events-none cursor-follower"><span class="circle"></span><span>${project.title ?? ""}</span></p><img${ssrRenderAttr("src", unref(imageBuilder).image(project.homepage_image))} class="pic w-full h-full object-cover"></figure>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(isMobile) && project.homepage_image_mobile) {
            _push(`<figure class="w-full group"><p class="projectName opacity-0 group-hover:opacity-100 transition-opacity duration-500 fixed pointer-events-none cursor-follower"><span class="circle"></span><span>${project.title ?? ""}</span></p><img${ssrRenderAttr("src", unref(imageBuilder).image(project.homepage_image_mobile))} class="pic w-full h-full object-cover"></figure>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(isMobile)) {
            _push(`<p>${project.title ?? ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</a>`);
...
//# sourceMappingURL=index-BvrjbVxK.js.map
