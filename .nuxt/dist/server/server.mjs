import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, watch, nextTick, computed, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, Suspense, mergeProps, Transition, Fragment, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-D1WdX2Rx.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BZarTlTb.js").then((m) => m.default || m)
  },
  {
    name: "progetti-slug",
    path: "/progetti/:slug()",
    component: () => import("./_nuxt/_slug_-DePDuR7-.js").then((m) => m.default || m)
  },
  {
    name: "project-index",
    path: "/project-index",
    component: () => import("./_nuxt/project-index-Dal89lRi.js").then((m) => m.default || m)
  },
  {
    name: "vision",
    path: "/vision",
    component: () => import("./_nuxt/vision-aYach_wN.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BzeVUFS0.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cz4jA0VI.js").then((r) => r.default || r));
